...
fun getComposeRule(): ComposeContentTestRule {
    return ComposeRuleContainer.rule ?: throw UltronException("Initialise ComposeTestRule using createUltronComposeRule<A>() factory method.")
}

fun getTestContext(): TestContext {
    return ComposeRuleContainer.testContext ?: throw UltronException("Initialise ComposeTestRule using createUltronComposeRule<A>() factory method.")
}